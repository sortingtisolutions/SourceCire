...
WHERE bg.ver_id = $verId GROUP BY cr.crp_id ORDER BY sbc_order_print, bdg_section, bdg_id";
...
/* Tabla Terminos y condiciones -------------------------  */
/* Tabla firmas -------------------------  */ // Modificado por edna para agregar toda la tabla de terminos y condiciones a una hoja aparte, de modo que no se generen cortes.
$html1 .= '
