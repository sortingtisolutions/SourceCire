...
function getData(){
    let pjtId = $('#periodsTable').attr('data-project')
    let prdId = $('#periodsTable').attr('data-product');

    console.log(pjtId);
    var pagina = 'ProjectPlans/getPeriodProject';
    var par = `[{"pjtId":"${pjtId}"}]`;
    var tipo = 'json';
    var selector = putPeridoProject;
    fillField(pagina, par, tipo, selector);
}

function putPeridoProject(dt){
    console.log(dt);
}