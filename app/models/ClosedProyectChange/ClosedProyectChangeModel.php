...
// Listado de proyectos
    public function listProjects($params)
    {
        $qry = "SELECT pj.pjt_id, pj.pjt_name, pj.pjt_number, pt.pjttp_name,
                ...
                pj.pjt_status,pj.pjt_id, cus.cus_name, cus.cus_legal_representative, cus.cus_contact_name
                FROM ctt_projects AS pj 
                LEFT JOIN ctt_projects_type As pt ON pt.pjttp_id = pj.pjttp_id
                LEFT JOIN ctt_customers_owner AS cou ON cou.cuo_id = pj.cuo_id
                LEFT JOIN ctt_customers AS cus ON cus.cus_id = cou.cus_id 
                WHERE pj.pjt_status in ('1','2','4','7','8') ORDER BY pjt_date_start ASC;";
        return $this->db->query($qry);
    }    

    public function list_Projects($params)
    {
